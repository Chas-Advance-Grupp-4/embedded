 ...
 * - Ensure that `wifi_config.h` is excluded from version control (e.g., via
 * `.gitignore`) to avoid exposing sensitive information.
 *
...
// #define TEST_SENSOR_UNIT_ID = "00000000-0000-0000-0000-000000000000"; 

#define WIFI_SECRET_SSID "Network"
#define WIFI_SECRET_PASS "Password"
#define CLIENT_URL "https://<your-url>"

// See /helpers/jwtgenerator for more information
#define SECRET_JWT "<your-generated-jwt>" 
// Add your unique Contol Unit Id here
#define CONTROL_UNIT_ID "00000000-0000-0000-0000-000000000000" 
...
#define CONTROL_UNIT_PORT 8080         // Set desired port
